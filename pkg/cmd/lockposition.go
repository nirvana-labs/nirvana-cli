...
var vektorLockPositionsList = cli.Command{
	Name:  "list",
	Usage: "Get info on locked positions",
	Flags: []cli.Flag{
	...
	Action:          handleVektorLockPositionsList,
	HideHelpCommand: true,
}

func handleVektorLockPositionsList(ctx context.Context, cmd *cli.Command) error {
	...
	params := vektor.LockPositionListParams{}
	...
	_, err = client.Vektor.Lock.Positions.List(ctx, params, options...)
	if err != nil {
		return err
	}
	...
	return ShowJSON(os.Stdout, "vektor:lock:positions list", obj, format, transform)
}
