...
var vektorBuyQuotesList = cli.Command{
	Name:  "list",
	Usage: "Get quotes for buying an exact amount of an asset at current market rate",
	Flags: []cli.Flag{
	...
	Action:          handleVektorBuyQuotesList,
	HideHelpCommand: true,
}

func handleVektorBuyQuotesList(ctx context.Context, cmd *cli.Command) error {
	...
	params := vektor.BuyQuoteListParams{}
	...
	_, err = client.Vektor.Buy.Quotes.List(ctx, params, options...)
	if err != nil {
		return err
	}
	...
	return ShowJSON(os.Stdout, "vektor:buy:quotes list", obj, format, transform)
}
