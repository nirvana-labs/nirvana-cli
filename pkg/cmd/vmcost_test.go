...
func TestComputeVMsCostCreate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"compute:vms:cost", "create",
	...
	t.Run("inner flags", func(t *testing.T) {
		...
		requestflag.CheckInnerFlags(computeVMsCostCreate)
...
func TestComputeVMsCostUpdate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	t.Run("regular flags", func(t *testing.T) {
		mocktest.TestRunMockTestWithFlags(
			t,
			"--api-key", "string",
			"compute:vms:cost", "update",
			"--vm-id", "vm_id",
			"--instance-type", "n1-standard-8",
			"--name", "my-vm",
			"--public-ip-enabled=true",
