...
var vektorBuyBuyCreate = cli.Command{
	Name:  "create",
	Usage: "Buy an asset with another asset",
	Flags: []cli.Flag{
	...
	Action:          handleVektorBuyBuyCreate,
	HideHelpCommand: true,
}

func handleVektorBuyBuyCreate(ctx context.Context, cmd *cli.Command) error {
	...
	_, err = client.Vektor.Buy.Buy.New(ctx, params, options...)
	if err != nil {
		return err
	}
	...
	return ShowJSON(os.Stdout, "vektor:buy:buy create", obj, format, transform)
}
